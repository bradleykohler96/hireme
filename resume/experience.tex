...
%---------------------------------------------------------
  \cventry
    {Student Employee \& Software Developer} % Job title
    {Emnor Mechanical Inc.} % Organization
    {Hamilton, Ontario} % Location
    {May 2016 - Sept. 2016} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
%---------------------------------------------------------
  \cventry
    {Software Engineering Teaching Assistant} % Job title
    {McMaster University} % Organization
    {Hamilton, Ontario} % Location
    {May. 2015 - Dec. 2015} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
%---------------------------------------------------------
  \cventry
    {Mechanical Repairman \& Shop Employee} % Job title
    {Emnor Mechanical Inc.} % Organization
    {Hamilton, Ontario} % Location
